...
let selectBookById = function(Id){
    let _sql = `select bt.Name,b.Name as BookName,b.Isbn,b.Author,b.BookPhoto,b.Price,b.Quantity,b.Describe,DATE_FORMAT(b.PublishTime,'%Y年%m月%d日') as PublishTime,b.PublishCompany,b.IsToCart,b.IsMember,b.IsHot from Books b left join Books_Type bt on bt.Id=b.BookTypeId where b.Id=${Id}`
    return query(_sql);
}
// 通过TypeId查所有图书信息
