...
let selectBookListById = function(value){
    let _sql = "select bt.Name,b.BookPhoto,b.Price,b.Quantity,b.Describe,b.PublishTime,b.PublishCompany,b.IsToCart from books b,books_type bt where b.BookTypeId=? and bt.Id=?"
    return query(_sql,value);
}
//暴露所有函数接口
module.exports = {
