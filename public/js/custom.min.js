...
$('.right_col .getUserModal').click(function(){
    ...
    var footer=getUserFooter(isCreate,obj.Id)
    var el='#userModal'
...
// user footer
function getUserFooter(flag,Id){
    return `<div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
        <button type="button" class="btn btn-primary" onclick="${flag?'addUsers()':'editUsers('+Id+')'}">保存</button>
    </div>`
}
// 新增用户信息
function addUsers(){
